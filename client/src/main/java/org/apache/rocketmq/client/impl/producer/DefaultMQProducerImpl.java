...
public class DefaultMQProducerImpl implements MQProducerInner {
    ...
    private SendResult sendDefaultImpl(//
        ...
        // 获取topic route信息,进而获取topic MessageQueue信息
    ...
    // 本地没有topic路由信息，就去nameServer中获取，nameServer中没有topic信息，则使用默认的"TBW102"topic
    private TopicPublishInfo tryToFindTopicPublishInfo(final String topic) {
        TopicPublishInfo topicPublishInfo = this.topicPublishInfoTable.get(topic);
        if (null == topicPublishInfo || !topicPublishInfo.ok()) {
            this.topicPublishInfoTable.putIfAbsent(topic, new TopicPublishInfo());
            // 从nameServer中获取TopicRouteInfo并更新topicPublishInfoTable数据
        ...
        if (topicPublishInfo.isHaveTopicRouterInfo() || topicPublishInfo.ok()) {
            ...
            // 从nameServer中获取默认的TopicRouteInfo(TBW102)并更新topicPublishInfoTable数据
    ...
    public TransactionSendResult sendMessageInTransaction(final Message msg, final LocalTransactionExecuter tranExecuter, final Object arg)
        ...
        transactionSendResult.setUniqueKey(sendResult.getUniqueKey());
    ...
    public void endTransaction(//
        ...
        final MessageId id;
        if (sendResult.getMsgId() != null) {
            id = MessageDecoder.decodeMessageId(sendResult.getMsgId());
        } else {
            id = MessageDecoder.decodeMessageId(sendResult.getUniqueKey());
        }
        ...
        requestHeader.setMsgId(sendResult.getUniqueKey());
